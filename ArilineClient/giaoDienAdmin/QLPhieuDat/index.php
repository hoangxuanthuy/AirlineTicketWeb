    ...
    <div class="row">
        ...
        <nav class="col-md-3 col-lg-2 d-md-block sidebar py-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a href="QLPhieuDat.html" class="nav-link active">Phiếu đặt</a></li>
                ...
                <li class="nav-item"><a href="../QLPhieuDat/index.php" class="nav-link active">Phiếu đặt</a></li>
