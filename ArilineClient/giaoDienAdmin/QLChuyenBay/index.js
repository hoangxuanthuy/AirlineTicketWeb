...
`;
    ...
    function displayData(flights) {
        ...
        <tr>
            ...
            <td>${flight.flight_name || 'Không xác định'}</td>
            <td>${flight.address || 'Không xác định'}</td>
            <td>
    ...
    function Insert(event) {
        ...
        const formData = {
            flight_name: document.getElementById('flight_name').value.trim(),
    ...
    function Update(event) {
        ...
        // Thu thập dữ liệu từ form
        const updatedData = {
            weight: document.getElementById('flight_name').value.trim(),
    ...
    function editRow(button, flightId) {
        ...
        document.getElementById('flight_name').value = weight;
