...
function Insert(event) {
    ...
    fetch('http://172.16.0.13:8000/api/customers', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${authToken}`
...
function Update(event) {
    ...
    fetch(`http://172.16.0.13:8000/api/customers/${customerId}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${authToken}`
...
function deleteRow(clientId) {
    ...
    fetch(`http://172.16.0.13:8000/api/customers/${clientId}`, {
        method: 'DELETE',
        headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer ${authToken}`
