document.addEventListener('DOMContentLoaded', function () {
    ...
    if (continueBtn) {
        continueBtn.addEventListener('click', function (e) {
            ...
            if (validateForm()) {
                ...
                if (confirmation) {
                    window.location.href = "../review/index.php"; // Thay bằng đường dẫn trang thực tế
                }
            }
        });
    }
    ...
    progressSteps.forEach((step, index) => {
        step.addEventListener('click', function (e) {
            ...
            if (index === 0) {
                window.location.href = "../information/index.php"; // Điền thông tin
            } else if (index === 1) {
                window.location.href = "../Seat/index.php"; // Chọn chỗ ngồi
            } else if (index === 2) {
                window.location.href = "../review/index.php"; // Xem lại
            } else if (index === 3) {
                window.location.href = "../Pay/index.php"; // Thanh toán
            }
        });
    });
