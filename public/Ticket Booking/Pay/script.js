...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (continueBtn) {
        continueBtn.addEventListener('click', function (e) {
            ...
            if (validateForm()) {
                ...
                if (confirmation) {
                    window.location.href = "../Pay/index.php"; // Thay bằng đường dẫn trang tiếp theo
                }
            }
        });
    }
    ...
    progressSteps.forEach((step, index) => {
        step.addEventListener('click', function (e) {
            ...
            const pages = [
                "../information/index.php", // Điền thông tin
                "../Seat/index.php", // Chọn chỗ ngồi
                "../review/index.php",      // Xem lại
                "../Pay/index.php"         // Thanh toán
            ];
    ...
    if (zaloPayButton) {
        zaloPayButton.addEventListener('click', function () {
            ...
            // window.location.href = "../../TEST/index.php"; // Navigate to TEST/index.php
            Book();
        });
    }
});
