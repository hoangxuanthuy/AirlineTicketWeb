    ...
    <main class="main-content">
        ...
        <div class="content-wrapper">
            <div class="passenger-form">
                ...
                <!-- Moved luggage selection inside passenger form -->
                <div class="luggage-section">
                    <h3>Chọn hành lý</h3>
                    <div class="luggage-options">
                        <div class="luggage-item" data-type="checkin">
                            <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%230066cc'%3E%3Cpath d='M19,8H5c-1.1,0-2,0.9-2,2v10c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V10C21,8.9,20.1,8,19,8z M19,20H5V10h14V20z M16,4h-2V2h-4v2H8v2h8V4z'/%3E%3C/svg%3E"
                                class="luggage-icon" alt="Ký gửi">
                            <span class="luggage-type">Ký gửi</span>
                            <span class="luggage-weight">20kg</span>
                        </div>
                        <div class="luggage-item" data-type="infant">
                            <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%230066cc'%3E%3Cpath d='M19,8H5c-1.1,0-2,0.9-2,2v10c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V10C21,8.9,20.1,8,19,8z M19,20H5V10h14V20z M16,4h-2V2h-4v2H8v2h8V4z'/%3E%3C/svg%3E"
                                class="luggage-icon" alt="Trẻ sơ sinh">
                            <span class="luggage-type">Trẻ sơ sinh</span>
                            <span class="luggage-weight">10kg</span>
                        </div>
                        <div class="luggage-item" data-type="carryon">
                            <img src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='%230066cc'%3E%3Cpath d='M19,8H5c-1.1,0-2,0.9-2,2v10c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V10C21,8.9,20.1,8,19,8z M19,20H5V10h14V20z M16,4h-2V2h-4v2H8v2h8V4z'/%3E%3C/svg%3E"
                                class="luggage-icon" alt="Xách tay">
                            <span class="luggage-type">Xách tay</span>
                            <span class="luggage-weight">7kg</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="details-panel">
                ...
                <!-- <div class="flight-info">
                    ...
                    <div class="flight-route">
                        <span class="airport">Đà Nẵng - TP HCM</span>
                    </div>
                    <div class="flight-route">
                ...
                <div class="container">
                    <div class="main-content">
                        ...
                        <div class="card">
                            <div class="price-header">
                                <h2 class="section-title">Giá bạn trả</h2>
                                <div class="total-price">2.960.000 VND</div>
                            </div>
                            <div class="price-row">
                                <div id="aaaa" class="price-label">TP HCM - Đà Nẵng (27-09-2024)</div>
                                <div class="price-value">1.240.000 VND</div>
                            </div>
                            <!-- <div class="price-row">
                                <div class="price-label">Đà Nẵng - TP HCM (29-09-2024)</div>
                                <div class="price-value">1.240.000 VND</div>
                            </div> -->
                            <div class="price-row">
                                <div id="cccc" class="price-label">Hành lý tới Đà Nẵng</div>
                                <div class="price-value">240.000 VND</div>
                            </div>
                            <!-- <div class="price-row">
                                <div class="price-label">Hành lý tới TP HCM</div>
                                <div class="price-value">240.000 VND</div>
                            </div> -->
                        </div>
                    </div>
                    ...
                    <div class="right-section">
                        <!-- Flight Selection -->
                        <div class="card">
                            <h2 class="section-title">Chọn chuyến bay</h2>
                            <div class="flight-option selected">
                                <div class="flight-number">1</div>
                                <div class="flight-details">
                                    <div class="flight-date" id="departure-date-1">27-09-2024</div>
                                    <div class="flight-route" id="departure-airport-1">TP HCM - Đà Nẵng</div>
                                </div>
                            </div>
                            <!-- <div class="flight-option">
                                <div class="flight-number">2</div>
                                <div class="flight-details">
                                    <div class="flight-date">29-09-2024</div>
                                    <div class="flight-route">Đà Nẵng - TP HCM</div>
                                </div>
                            </div> -->
                        </div>
                    </div>
                    ...
                    <div class="booking-preview-container">
                        <!-- Preview will be injected here by script.js -->
                    </div>
                ...
                <div class="button-container">
                    <button class="continue-btn" id="continue-btn1">Tiếp tục</button>
                </div>
            </div>
    </main>
